...
REAL_INCIDENTS = [
    {
        ...
        "indicators": [
            ...
            {"type": "ip", "value": "185.220.101.47", "confidence": 60, "severity": "Medium", "tlp": "WHITE", "country": "KE", "attack_type": "DDoS", "description": "[DERIVED] Tor exit node associated with Anonymous Sudan ops.", "source": "Open threat intel community"}
        ]
    },
    {
        "title": "LockBit 3.0 Ransomware on GPAA (South Africa)",
        "submitter_email": "sipho_ndlovu",
        "indicators": [
            ...
            {"type": "domain", "value": "lockbitapt2yfbt7mx2jsls3y5xhnpaauqkry4a5pmxjbhkn67od4sqd.onion", "confidence": 90, "severity": "Critical", "tlp": "WHITE", "country": "ZA", "attack_type": "Ransomware", "description": "LockBit 3.0 data leak .onion site.", "source": "CISA + open source OSINT"}
        ]
    },
    {
        ...
        "submitter_email": "sipho_ndlovu",
        "indicators": [
            {"type": "hash_sha256", "value": "b74bf56873e682a97b7e93c099540a8be6b5b0f29a30c8f48e5e0d57d621ef4e", "confidence": 80, "severity": "Critical", "tlp": "WHITE", "country": "ZA", "sector": "Defence", "attack_type": "Ransomware", "description": "Snatch ransomware binary associated with DoD South Africa breach.", "source": "CISA Advisory AA23-289A"},
            {"type": "ip", "value": "176.113.115.107", "confidence": 75, "severity": "Critical", "tlp": "WHITE", "country": "ZA", "attack_type": "Ransomware", "description": "Snatch group C2 server for exfiltration staging.", "source": "CISA Advisory AA23-289A"}
        ]
    },
    {
        ...
        "submitter_email": "fatuma_hassan",
        "indicators": [
            {"type": "domain", "value": "hunters55xp5b43blbglinosx46smiqzse7vco4u7b4w4g5sycbrhvad.onion", "confidence": 80, "severity": "High", "tlp": "WHITE", "country": "KE", "sector": "Transport", "attack_type": "Ransomware", "description": "Hunters International leak site. KURA 18GB data dump.", "source": "INTERPOL 2025"}
        ]
    },
    {
        "title": "Telecom Namibia Breach (Hunters International)",
        "submitter_email": "amara_diallo",
        "indicators": [
            {"type": "domain", "value": "hunters55xp5b43blbglinosx46smiqzse7vco4u7b4w4g5sycbrhvad.onion", "confidence": 85, "severity": "Critical", "tlp": "WHITE", "country": "NA", "sector": "Telecom", "attack_type": "Ransomware", "description": "Telecom Namibia 626GB breach dump.", "source": "INTERPOL 2025"}
        ]
    },
    {
        "title": "Flutterwave Fraud / Financial Cyber Heist",
        "submitter_email": "ngozi_okonkwo",
        "indicators": [
            {"type": "domain", "value": "api.flutterwave.com", "confidence": 90, "severity": "Critical", "tlp": "WHITE", "country": "NG", "sector": "Fintech", "attack_type": "Financial Fraud", "description": "Target API endpoint in Flutterwave USD 7M heist April 2024.", "source": "INTERPOL 2025"},
            {"type": "domain", "value": "flutterwav3.co", "confidence": 70, "severity": "High", "tlp": "WHITE", "country": "NG", "attack_type": "Phishing", "description": "[DERIVED] Typosquatted domain for Flutterwave BEC chain.", "source": "Open OSINT"}
        ]
    },
    {
        ...
        "submitter_email": "amara_diallo",
        "indicators": [
            {"type": "domain", "value": "mtn.co.ug", "confidence": 90, "severity": "High", "tlp": "WHITE", "country": "UG", "sector": "Telecom", "attack_type": "DDoS", "description": "MTN Uganda targeted by Anonymous Sudan HTTP flood.", "source": "A&D Forensics / INTERPOL 2025"},
            {"type": "domain", "value": "airtel.co.ug", "confidence": 90, "severity": "High", "tlp": "WHITE", "country": "UG", "sector": "Telecom", "attack_type": "DDoS", "description": "Airtel Uganda targeted by Anonymous Sudan DDoS.", "source": "A&D Forensics / INTERPOL 2025"}
        ]
    },
    {
    ...
    },
    {
        ...
        "submitter_email": "ngozi_okonkwo",
        "indicators": [
            {"type": "domain", "value": "nigerianstat.gov.ng", "confidence": 95, "severity": "Medium", "tlp": "WHITE", "country": "NG", "sector": "Government", "attack_type": "Defacement", "description": "Nigeria NBS website defaced December 2024.", "source": "A&D Forensics"}
        ]
    },
    {
        ...
        "submitter_email": "fatuma_hassan",
        "indicators": [
            {"type": "domain", "value": "msea.go.ke", "confidence": 90, "severity": "High", "tlp": "WHITE", "country": "KE", "sector": "Government", "attack_type": "Data Breach", "description": "Kenya MSEA records exfiltrated and sold on dark web.", "source": "A&D Forensics"}
        ]
    },
    {
        ...
        "submitter_email": "ngozi_okonkwo",
        "indicators": [
            {"type": "domain", "value": "mtn.com.ng", "confidence": 85, "severity": "Critical", "tlp": "WHITE", "country": "NG", "sector": "Telecom", "attack_type": "Financial Fraud", "description": "MTN Nigeria mobile money service defrauded of USD 53M.", "source": "Yusuph Kileo Report"}
        ]
    },
    {
        "title": "SideWinder APT Maritime Attacks",
        "submitter_email": "rania_mahmoud",
        "indicators": [
            {"type": "domain", "value": "mofa-pk.org", "confidence": 75, "severity": "High", "tlp": "WHITE", "country": "KE", "sector": "Maritime", "attack_type": "APT", "description": "SideWinder phishing domain targeting maritime sector in East Africa.", "source": "PT Security"},
            {"type": "ip", "value": "103.255.178.214", "confidence": 65, "severity": "High", "tlp": "AMBER", "country": "KE", "attack_type": "APT", "description": "C2 server associated with SideWinder maritime campaign.", "source": "PT Security"}
        ]
    },
    {
        ...
        "submitter_email": "rania_mahmoud",
        "indicators": [
            {"type": "hash_sha256", "value": "2c9e45b7e1b3a6f7c3da4e2e0b98d3a1c1e07c3b5f012234d8c1a9e0b6c4f2e1", "confidence": 70, "severity": "High", "tlp": "WHITE", "country": "MA", "sector": "Hospitality", "attack_type": "Ransomware", "description": "MEOW ransomware binary used in Es Saadi Hotel breach.", "source": "PT Security"},
    ...
    },
    {
        ...
        "submitter_email": "hawa_camara",
        "indicators": [
            {"type": "url", "value": "https://www.instagram.com/p/Csc8-LhO9/", "confidence": 80, "severity": "High", "tlp": "WHITE", "country": "NG", "sector": "Social Media", "attack_type": "Sextortion", "description": "Example lure account from Nigerian sextortion network.", "source": "Reuters"}
        ]
    }
]
