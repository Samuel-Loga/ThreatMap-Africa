...
from app.schemas import IndicatorCreate, IndicatorOut, IndicatorPaginated
...
@router.get("", response_model=IndicatorPaginated)
async def list_indicators(
    ...
    return IndicatorPaginated(items=indicators, total=total)
